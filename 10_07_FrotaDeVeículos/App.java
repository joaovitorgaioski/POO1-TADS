    ...
    public static void main(String[] args) {
        ...
        while (opcao != 0) {
            ...
            switch (opcao) {
                ...
                case 2:
                    System.out.println(
                            "Qual o tipo do veículo que gostaria de visualizar os dados?\n(1) - Carros de passeio\t(2) - Caminhão");
                    opcao = scan.nextInt();
                ...
                case 3:
                    ...
                    for (int i = 0; i < carros.size(); i++) {
                        carros.get(i).exibirStatusConcatenado();
                    }

                    System.out.println("\tCaminhões:");
                    for (int i = 0; i < caminhoes.size(); i++) {
                        caminhoes.get(i).exibirStatusConcatenado();
                    }
                    break;

                case 4:
                    System.out.println(
                            "Qual o tipo do veículo que gostaria de percorrer?\n(1) - Carro de passeio\t(2) - Caminhão");
                    opcao = scan.nextInt();
                    ...
                    switch (opcao) {
                        case 1:
                            ...
                            opcao = scan.nextInt();
                            System.out.println("Quilometragem anterior do " + carros.get(opcao).getModelo() + ": "
                                    + carros.get(opcao).getQuilometragem());
                        ...
                        case 2:
                            ...
                            opcao = scan.nextInt();
                            System.out.println("Quilometragem anterior do " + caminhoes.get(opcao).getModelo() + ": "
                                    + caminhoes.get(opcao).getQuilometragem());
                            ...
                            System.out
                                    .println("Nova quilometragem: " + caminhoes.get(opcao).getQuilometragem() + " km");
                            break;
                ...
                case 5:
                    ...
                    for (int i = 0; i < carros.size(); i++) {
                        System.out.println(
                                carros.get(i).getModelo() + ": " + carros.get(i).getQuilometragem() + " km rodados");
                    }

                    System.out.println("\tCaminhões:");
                    for (int i = 0; i < caminhoes.size(); i++) {
                        System.out.println(caminhoes.get(i).getModelo() + ": " + caminhoes.get(i).getQuilometragem()
                                + " km rodados");
                    }
                    break;
