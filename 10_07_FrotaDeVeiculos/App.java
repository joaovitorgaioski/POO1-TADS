                ...
                case 4:
                    ...
                    switch (opcao) {
                        case 1:
                            ...
                            opcao = scan.nextInt();
                            System.out.println("Quilometragem anterior do " + carros.get(opcao).getModelo() + ": " + carros.get(opcao).getQuilometragem());
                        ...
                        case 2:
                            ...
                            opcao = scan.nextInt();
                            System.out.println("Quilometragem anterior do " + caminhoes.get(opcao).getModelo() + ": " + caminhoes.get(opcao).getQuilometragem());
