...
public abstract class Veiculo {
    ...
    StringBuilder statusConcatenado = new StringBuilder();
    ...
    public void exibirStatusConcatenado() {
        ...
        statusConcatenado.append(getMarca()).append(" ").append(getModelo()).append(", ").append(getPlaca()).append(", ").append(getQuilometragem()).append(" km");
        statusConcatenado.toString();

        System.out.println(statusConcatenado);
        App.linhaHorizontal();
    }
